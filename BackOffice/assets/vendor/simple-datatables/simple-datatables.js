                        ...
                        (function () {
                                ...
                                return (
                                    "#text" === t.nodeName
                                        ...
                                        : (e
                                          ...
                                          s.valueDiffing &&
                                              (t.value &&
                                                  u(i, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") &&
                                                  (i.value = t.value),
                            ...
                            var w = function (t) {
                                ...
                                x = function (t) {
                                    ...
                                    return (
                                        Object.prototype.hasOwnProperty.call(t, "attributes") && (e.attributes = v({}, t.attributes)),
                            ...
                            function S(t, e) {
                                ...
                                if (u(t, "Text", "Comment")) s.data = t.data;
                                    ...
                                    e.valueDiffing &&
                                        ...
                                        u(t, "HTMLInputElement") && ["radio", "checkbox"].includes(t.type.toLowerCase()) && void 0 !== t.checked
                                            ? (s.checked = t.checked)
                                            : u(t, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") && (s.value = t.value),
                            ...
                            var L = { area: !0, base: !0, br: !0, col: !0, embed: !0, hr: !0, img: !0, input: !0, keygen: !0, link: !0, menuItem: !0, meta: !0, param: !0, source: !0, track: !0, wbr: !0 },
                                P = function (t, e) {
                                ...
                                H = (function () {
                                    function t(t, e, s) {
                                        (this.options = s),
                                            ...
                                            (this.foundAll = !1),
                                            this.debug &&
                                                ((this.t1Orig = "undefined" != typeof Element && u(t, "Element") ? S(t, this.options) : "string" == typeof t ? R(t, this.options) : JSON.parse(JSON.stringify(t))),
                                        ...
                                        (t.prototype.findDiffs = function (t, e) {
                                            ...
                                            do {
                                                ...
                                                0 === (s = this.findNextDiff(t, e, [])).length &&
                                                    (D(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : ((this.foundAll = !0), N(t), (s = this.findNextDiff(t, e, []))))),
                                                    s.length > 0 && ((this.foundAll = !1), this.tracker.add(s), C(t, s, this.options));
                                            } while (s.length > 0);
                                                    ...
                                                    (p && !f
                                                        ? "#text" === p.nodeName
                                                            ? (r.push(
                                                              ...
                                                              (l -= 1))
                                                            : (r.push(
                                                                  new h().setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, x(p))
                                                              ),
                                                              (l -= 1))
                                                        : f &&
                                                          !p &&
                                                          ("#text" === f.nodeName
                                                              ...
                                                              : r.push(
                                                                    new h().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, x(f))
                                                                ))),
                                                    p &&
                                                        f &&
                                                        (!this.options.maxChildCount || a < this.options.maxChildCount
                                                            ? (r = r.concat(this.findNextDiff(p, f, s.concat(l))))
                                                            : D(p, f) ||
                                                              (i.length > n.length
                                                                  ? ("#text" === p.nodeName
                                                                        ? r.push(
                                                                  ...
                                                                  ? ((r = r.concat([
                                                                        new h()
                                                                            ...
                                                                            .setValue(this.options._const.element, x(f))
                                                                            .setValue(this.options._const.route, s.concat(l)),
                                                                    ])),
                                                                    i.splice(u, 0, x(f)),
                                                                    (o -= 1))
                                                                  : (r = r.concat([
                                                                        new h()
                                                                            .setValue(this.options._const.action, this.options._const.replaceElement)
                                                                            .setValue(this.options._const.oldValue, x(p))
                                                                            .setValue(this.options._const.newValue, x(f))
                                                                            .setValue(this.options._const.route, s.concat(l)),
                                                                    ])))),
                                                    (l += 1);
                                            }
                                            ...
                                            for (
                                                ...
                                                if (!n || (!0 !== u[v] && !0 !== p[v])) {
                                                    if (!0 === u[w])
                                                            ...
                                                            !0 === p[v]
                                                                ? b.push(
                                                                      new h()
                                                                          ...
                                                                          .setValue(this.options._const.newValue, x(m[v]))
                                                                          .setValue(this.options._const.route, i.concat(w))
                                                                  )
                                                                : (b.push(
                                                                      new h()
                                                        ...
                                                        "#text" === (l = m[v]).nodeName
                                                            ? (b.push(
                                                                  new h().setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.value, l.data)
                                                              ),
                                                              u.splice(w, 0, !0),
                                                              f.splice(w, 0, { nodeName: "#text", data: l.data }),
                                                              (g = Math.min(u.length, p.length)))
                                                            : (b.push(
                                                                  new h().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, x(l))
                                                              ),
                                                              u.splice(w, 0, !0),
                                                              f.splice(w, 0, x(l)),
                                                              (g = Math.min(u.length, p.length)));
                            ...
                            const j = (t, e, s, { classes: i, format: n, hiddenHeader: a, sortable: o, scrollY: r, type: l }, { noColumnWidths: d, unhideHeader: h }) => ({
                                ...
                                q = (
                                    ...
                                    if (((x.attributes.class = c(x.attributes.class, r.table)), d || h || _)) {
                                        const t = j(e, i, a, { classes: r, hiddenHeader: l, sortable: p, scrollY: f }, { noColumnWidths: v, unhideHeader: w });
                                        if (d || _) {
                                ...
                                Q = (t, e) => {
                                    ...
                                    switch (e.type) {
                                        ...
                                        case "number":
                                            ...
                                            break;
                                        case "html": {
                                            const t = Array.isArray(s.data) ? { nodeName: "TD", childNodes: s.data } : R(`<td>${String(s.data)}</td>`);
                                            s.data = t.childNodes || [];
                                            const e = i(t);
                                            (s.text = e), (s.order = e);
                                            break;
                                ...
                                Z = (t, e = void 0, s, n, a) => {
                                    ...
                                    if (
                                        (t.data
                                            ? (o.data = t.data.map((t) => {
                                                  let e, i;
                                                  return Array.isArray(t) ? ((e = {}), (i = t)) : ((e = t.attributes), (i = t.cells)), { attributes: e, cells: i.map((t, e) => Q(t, s[e])) };
                                              }))
                                            : e?.tBodies?.length &&
                            ...
                            const tt = {
                                    ...
                                    labels: {
                                        ...
                                        perPage: "Iniciativas por página",
                                        pageTitle: "Page {page}",
                                        noRows: "Sem iniciativas encontradas",
                                        noResults: "Sem resultados",
                                        info: "{end} de {rows} iniciativas",
                                    },
                                    template: (t, e) =>
                            ...
                            (exports.DataTable = class {
                                ...
                                _renderSeparateHeader() {
                                    ...
                                    let e = {
                                        ...
                                        childNodes: [{ nodeName: "THEAD", childNodes: [j(this.data.headings, this.columns.settings, this.columns._state, this.options, { unhideHeader: !0 })] }],
                                    };
                                        ...
                                        e.forEach((e, i) => {
                                            ...
                                            Object.entries(e).forEach(([e, s]) => {
                                                ...
                                                a > -1
                                                    ...
                                                    : this.hasHeadings || this.hasRows || 0 !== i || ((n[t.length] = Q(s, this.columns.settings[t.length])), t.push(e), this.data.headings.push(X(e)));
                                            }),
                                                s.push({ cells: n });
                                        });
                                    } else
                                ...
                                setMessage(t) {
                                    ...
                                    let s = {
                                        ...
                                        attributes: this._tableAttributes,
                                        childNodes: [
                                            { nodeName: "THEAD", childNodes: [j(this.data.headings, this.columns.settings, this.columns._state, this.options, {})] },
                                            {
                                                nodeName: "TBODY",
